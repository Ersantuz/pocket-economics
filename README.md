...
1. [MathJax:](https://www.mathjax.org/)
    - MathJax was used to embed markdown syntax in the html file, providing an easy way to write all the equations.
...
-   #### First Time Visitor Goals
    ...
    1. The user has two options, navigate the website through a clear navigation bar or using the call to action button accessible by scrolling down the home page. Both choice will lead to the same results.
...
-   All Images were created on [Ouch!](https://icons8.com/illustrations) by the developer.
