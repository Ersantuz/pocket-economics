...
-   ### Design
    ...
    -   #### Typography
        -   The Inter font is the main font used throughout the whole website with Sans Serif as the fallback font in case for any reason the font isn't being imported into the site correctly. Inter is a font used frequently in notes app, so it is both attractive and appropriate.

*   ### Wireframes

    -   Widescreen Wireframe - <a href="assets/pdf/PocketEconomics - Mobile.pdf" target="_blank">View</a> 
